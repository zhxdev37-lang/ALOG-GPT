...
<div class="dashboard-content">
    <div class="mb-4">
        <h4 class="fw-bold mb-1">Categorie: <?= e($category['name'] ?? 'Blog') ?></h4>
        <p class="text-secondary mb-0">Articles dans cette categorie</p>
    </div>
    ...
    <div class="row g-4">
        ...
        <div class="col-12 text-center text-muted py-5">Aucun article dans cette categorie.</div>
        <?php endif; ?>
    </div>
